...
CREATE TABLE IF NOT EXISTS haul_request (
  ...
  status             ENUM('requested','awaiting_contract','in_queue','in_progress','completed','cancelled','draft','quoted','submitted','posted','accepted','in_transit','delivered','expired','rejected') NOT NULL DEFAULT 'requested',
