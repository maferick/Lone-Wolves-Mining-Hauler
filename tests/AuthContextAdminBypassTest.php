...
$pdo->exec("CREATE TABLE app_user (user_id INTEGER PRIMARY KEY, corp_id INTEGER, character_id INTEGER, character_name TEXT, display_name TEXT, email TEXT, status TEXT, session_revoked_at TEXT)");
...
$pdo->exec("CREATE TABLE discord_config (corp_id INTEGER, role_map_json TEXT)");
